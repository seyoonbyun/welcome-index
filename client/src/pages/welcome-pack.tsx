...
export default function WelcomePackPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-white" style={{ fontFamily: '"Pretendard Variable", Pretendard, sans-serif' }}>
      ...
      <motion.button
        className="fixed bottom-12 right-8 md:bottom-20 w-11 h-11 md:w-14 md:h-14 bg-bni-red text-white rounded-full shadow-lg flex items-center justify-center z-50 hover:bg-bni-red-dark transition-colors"
        onClick={scrollToTop}
